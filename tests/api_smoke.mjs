...
assert(diagnosis.app_version === '1.6.75', `expected app_version 1.6.75, got ${diagnosis.app_version}`);
...
assert(appJs.includes("const APP_VERSION = '1.6.75'"), 'app should expose v1.6.75 internally/API-side');
...
assert(indexHtml.includes('/app.js?v=1.6.75') && indexHtml.includes('/war-room-v1.6.1.css?v=1.6.75'), 'customer page should cache-bust current v1.6.75 assets');
