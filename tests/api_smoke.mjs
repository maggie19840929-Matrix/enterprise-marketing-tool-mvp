...
assert(appJs.includes("const APP_VERSION = '1.6.145'") && appJs.includes("v1.6.145 · 三平台账号起步设置版"), 'application should expose the reviewed v1.6.145 platform-specific account setup release');
...
assert(health.version === '1.6.145' && health.version_label === 'v1.6.145 · 三平台账号起步设置版', 'public application health version should report v1.6.145');
