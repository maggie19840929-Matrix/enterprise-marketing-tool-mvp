...
assert(appJs.includes("const APP_VERSION = '1.6.143'") && appJs.includes("v1.6.143 · 项目名称防溢出版"), 'application should expose the reviewed v1.6.143 project-name overflow release');
...
assert(health.version === '1.6.143' && health.version_label === 'v1.6.143 · 项目名称防溢出版', 'public application health version should report v1.6.143');
