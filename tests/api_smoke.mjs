...
assert(diagnosis.app_version === '1.6.134', `public diagnosis should return app_version 1.6.134, got ${diagnosis.app_version}`);
...
assert(appJs.includes("const APP_VERSION = '1.6.134'") && appJs.includes("v1.6.134 · 登录与套餐排版精修版"), 'public app should expose the reviewed v1.6.134 account and plans presentation release');
...
assert(indexHtml.includes('/app.js?v=1.6.134') && indexHtml.includes('/styles.css?v=1.6.134') && indexHtml.includes('/war-room-v1.6.1.css?v=1.6.134'), 'public customer page should use the v1.6.134 cache-busted asset references');
...
assert(indexHtml.includes('fp-matrix-lockup') && indexHtml.includes('fp-matrix-elephant.svg?v=1.6.134') && indexHtml.includes('/fp-matrix-favicon.svg?v=1.6.134') && indexHtml.includes('<strong>FP</strong><em>MATRIX</em>') && indexHtml.includes('企业第一方增长智能'), 'customer page should expose the official FP Matrix lockup and dedicated favicon');
assert(indexHtml.includes('customer-product-lockup') && indexHtml.includes('/huoke-compass-mark.svg?v=1.6.134') && indexHtml.includes('获客<span>罗盘</span>') && indexHtml.includes('by FP Matrix'), 'customer hero should expose the Huoke Compass product lockup below the parent brand');
...
assert([methodHtml, aboutHtml, privacyHtml, termsHtml, contactHtml].every((html) => html.includes('fp-matrix-lockup') && html.includes('企业第一方增长智能') && html.includes('/fp-matrix-elephant.svg?v=1.6.134') && html.includes('/fp-matrix-favicon.svg?v=1.6.134')), 'all independent customer information pages should use the same finalized FP Matrix identity and current cache version');
...
[indexHtml, methodHtml, aboutHtml, contactHtml, privacyHtml, termsHtml].forEach((html) => {
...
assert([methodHtml, aboutHtml, contactHtml, privacyHtml, termsHtml].every((html) => html.includes('war-room-v1.6.1.css?v=1.6.134') && html.includes('class="customer-account-nav" href="/?account=login"') && !html.includes('v=1.6.99')), 'all independent information pages should use the current navigation assets and account entry');
...
assert(health.version === '1.6.134' && health.version_label === 'v1.6.134 · 登录与套餐排版精修版', 'public application health version should report v1.6.134');
