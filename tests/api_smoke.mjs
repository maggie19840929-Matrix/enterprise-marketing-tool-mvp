...
assert(indexHtml.includes('/app.js?v=1.6.79') && indexHtml.includes('/war-room-v1.6.1.css?v=1.6.81'), 'customer page should cache-bust the v1.6.81 footer refinement while preserving v1.6.79 app logic');
...
assert(indexHtml.includes('customer-footer-primary') && indexHtml.includes('customer-footer-meta') && indexHtml.includes('© 2016–2026 南京尚下联信息科技有限公司') && indexHtml.includes('mailto:contact@fpmatrix.cn') && warRoomCss.includes('.customer-footer-meta>*:not(:first-child)::before'), 'customer footer should keep company, email and filing as linked elements in one refined meta line');
