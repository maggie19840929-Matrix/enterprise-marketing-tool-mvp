...
const INTERNAL_ACCESS_TOKEN = 'smoke-internal-token-1.6.91';
process.env.INTERNAL_ACCESS_TOKEN = INTERNAL_ACCESS_TOKEN;
process.env.METERING_HASH_SECRET = 'smoke-metering-secret-v1.6.91-not-production';
...
assert(diagnosis.app_version === '1.6.91', `expected app_version 1.6.91, got ${diagnosis.app_version}`);
...
assert(appJs.includes("const APP_VERSION = '1.6.91'"), 'app should expose v1.6.91 internally/API-side');
...
assert(indexHtml.includes('/app.js?v=1.6.91') && indexHtml.includes('/styles.css?v=1.6.91') && indexHtml.includes('/war-room-v1.6.1.css?v=1.6.91'), 'customer page should cache-bust the v1.6.91 Video Account tone release while preserving the centered footer stylesheet');
