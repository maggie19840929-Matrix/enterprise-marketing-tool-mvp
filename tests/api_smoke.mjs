...
assert(diagnosis.app_version === '1.6.59', `expected app_version 1.6.59, got ${diagnosis.app_version}`);
...
assert(appJs.includes("const APP_VERSION = '1.6.59'"), 'app should expose v1.6.59 internally/API-side');
...
assert(indexHtml.includes('/app.js?v=1.6.59') && indexHtml.includes('/war-room-v1.6.1.css?v=1.6.59'), 'customer page should cache-bust current v1.6.59 assets');
