...
assert(diagnosis.app_version === '1.6.72', `expected app_version 1.6.72, got ${diagnosis.app_version}`);
...
assert(appJs.includes("const APP_VERSION = '1.6.72'"), 'app should expose v1.6.72 internally/API-side');
...
assert(indexHtml.includes('/app.js?v=1.6.72') && indexHtml.includes('/war-room-v1.6.1.css?v=1.6.72'), 'customer page should cache-bust current v1.6.72 assets');
...
assert(warRoomCss.includes('v1.6.72 visible legal footer') && warRoomCss.includes('body.customer-mode .customer-site-footer') && warRoomCss.includes('background:#fff!important') && warRoomCss.includes('font-weight:780!important'), 'customer footer legal information should be visually prominent');
