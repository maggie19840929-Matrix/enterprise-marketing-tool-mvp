...
assert(indexHtml.includes('/app.js?v=1.6.79') && indexHtml.includes('/war-room-v1.6.1.css?v=1.6.80'), 'customer page should cache-bust the v1.6.80 visual refinement while preserving v1.6.79 app logic');
