...
assert(appJs.includes("const APP_VERSION = '1.6.142'") && appJs.includes("v1.6.142 · 客户工作区体验优化版"), 'application should expose the reviewed v1.6.142 customer workspace release');
...
assert(health.version === '1.6.142' && health.version_label === 'v1.6.142 · 客户工作区体验优化版', 'public application health version should report v1.6.142');
