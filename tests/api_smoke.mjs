...
assert(appJs.includes("const APP_VERSION = '1.6.148'") && appJs.includes("v1.6.148 · 当前项目仓恢复版"), 'application should expose the reviewed v1.6.148 current-project-store recovery release');
...
assert(health.version === '1.6.148' && health.version_label === 'v1.6.148 · 当前项目仓恢复版', 'public application health version should report v1.6.148');
