...
assert(appJs.includes("const APP_VERSION = '1.6.144'") && appJs.includes("v1.6.144 · 账号起步设置排版修复版"), 'application should expose the reviewed v1.6.144 account setup readability release');
...
assert(health.version === '1.6.144' && health.version_label === 'v1.6.144 · 账号起步设置排版修复版', 'public application health version should report v1.6.144');
