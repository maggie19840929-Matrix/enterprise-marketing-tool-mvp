...
assert(diagnosis.app_version === '1.6.135', `public diagnosis should return app_version 1.6.135, got ${diagnosis.app_version}`);
...
assert(appJs.includes("const APP_VERSION = '1.6.135'") && appJs.includes("v1.6.135 · 账号菜单与流程排版精修版"), 'public app should expose the reviewed v1.6.135 shared account-menu release');
...
assert(indexHtml.includes('/app.js?v=1.6.135') && indexHtml.includes('/styles.css?v=1.6.135') && indexHtml.includes('/war-room-v1.6.1.css?v=1.6.135'), 'public customer page should use the v1.6.135 cache-busted asset references');
...
assert(indexHtml.includes('fp-matrix-lockup') && indexHtml.includes('fp-matrix-elephant.svg?v=1.6.135') && indexHtml.includes('/fp-matrix-favicon.svg?v=1.6.135') && indexHtml.includes('<strong>FP</strong><em>MATRIX</em>') && indexHtml.includes('企业第一方增长智能'), 'customer page should expose the official FP Matrix lockup and dedicated favicon');
assert(indexHtml.includes('customer-product-lockup') && indexHtml.includes('/huoke-compass-mark.svg?v=1.6.135') && indexHtml.includes('获客<span>罗盘</span>') && indexHtml.includes('by FP Matrix'), 'customer hero should expose the Huoke Compass product lockup below the parent brand');
...
assert([methodHtml, aboutHtml, privacyHtml, termsHtml, contactHtml].every((html) => html.includes('fp-matrix-lockup') && html.includes('企业第一方增长智能') && html.includes('/fp-matrix-elephant.svg?v=1.6.135') && html.includes('/fp-matrix-favicon.svg?v=1.6.135')), 'all independent customer information pages should use the same finalized FP Matrix identity and current cache version');
...
[indexHtml, plansHtml, methodHtml, aboutHtml, contactHtml, privacyHtml, termsHtml].forEach((html) => {
...
assert([plansHtml, methodHtml, aboutHtml, contactHtml, privacyHtml, termsHtml].every((html) => html.includes('war-room-v1.6.1.css?v=1.6.135') && html.includes('/public-account-menu.js?v=1.6.135') && !html.includes('class="customer-account-nav" href="/?account=login"')), 'all independent public pages should load the shared session-aware account menu instead of a static login link');
...
assert(warRoomCss.includes('gap:19px!important') && warRoomCss.includes('min-height:31px!important') && warRoomCss.includes('font-weight:500!important'), 'customer navigation should retain the compact, lower-weight visual hierarchy');
...
assert(health.version === '1.6.135' && health.version_label === 'v1.6.135 · 账号菜单与流程排版精修版', 'public application health version should report v1.6.135');
