...
assert(diagnosis.app_version === '1.7.0', `expected app_version 1.7.0, got ${diagnosis.app_version}`);
...
assert(indexHtml.includes('v1.7.0 · 首访填写体验修复版'), 'index should show v1.7.0 label');
